...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Quiz_t, stringdata0) + ofs), len 
...
const QMetaObject Quiz::staticMetaObject = { {
    ...
    qt_meta_stringdata_Quiz.offsetsAndSize,
    qt_meta_data_Quiz,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Quiz_t
